...
<head>
    ...
    <title> Wishlist - AristoNut</title>
    ...
    <style>
        ...
        body { font-family: 'Poppins', sans-serif; background: #fffaf5; color: #3E2723; }
        .text-brown { color: #8B4513; }
        .wishlist-wrapper-card { background: #ffffff; border-radius: 20px; border: 2px solid #F5E6D3; overflow: hidden; transition: 0.3s; }
        .wishlist-prod-img { width: 100%; height: 200px; object-fit: contain; background: #fffaf5; padding: 15px; }
        .btn-add-cart-wish { background: #8B4513; color: #fff; border: none; border-radius: 20px; font-size: 0.9rem; padding: 8px 20px; width: 100%; transition: 0.3s; }
        .btn-add-cart-wish:hover { background: #6D3410; }
        .remove-wish-icon { position: absolute; top: 15px; right: 15px; background: #fff; color: #dc3545; border: 1px solid #fee2e2; border-radius: 50%; width: 35px; height: 35px; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; transition: 0.3s; box-shadow: 0 4px 10px rgba(0,0,0,0.05); }
        .remove-wish-icon:hover { background: #dc3545; color: #fff; }
    </style>
    <style>
        * {
            margin: 0;
