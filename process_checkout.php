...
<head>
    ...
    <style>
        ...
        .status-box { background: #fff; padding: 40px; border-radius: 20px; box-shadow: 0 10px 30px rgba(139, 69, 19, 0.05); border: 2px solid #F5E6D3; }
        .text-brown { color: #8B4513; }
        .btn-home { background: #8B4513; color: #fff; border-radius: 25px; padding: 10px 30px; border: none; font-weight: 500; transition: 0.3s; text-decoration: none; display: inline-block; }
        .btn-home:hover { background: #6D3410; color: #fff; }
    </style>
</head>
