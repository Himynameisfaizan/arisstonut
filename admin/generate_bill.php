        ...
        <div class="invoice-card mx-auto" style="max-width: 850px;">
            ...
            <div class="row invoice-header align-items-center">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <img src="../assets/images/logo.jpg" alt="AristoNut Logo" style="width: 200px; height: 80px; object-fit: contain; display: block; margin-bottom: 10px;">
            ...
            <div style="text-align: center; margin-top: 40px; padding-top: 20px; border-top: 2px dashed #eee;">
    <h4 style="color: #9C5521; font-family: 'Poppins', sans-serif; font-weight: 700; margin-bottom: 5px;">"Nourishing Lives with Every Crunch!"</h4>
    <p style="color: #6B5B53; font-size: 0.9rem; margin-top: 0;">Thank you for bringing AristoNut into your home. We're thrilled to share the authentic, premium taste of Mithila with you.</p>
    <p style="color: #999; font-size: 0.75rem; margin-top: 15px;">This is an electronically generated invoice. No physical signature is required.</p>
</div>
